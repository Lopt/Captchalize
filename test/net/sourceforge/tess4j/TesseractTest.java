...
public class TesseractTest {
    ...
    public void testDoOCR_File() throws Exception {
        ...
        File imageFile = new File(testdata + "eurotext.png");
    ...
    public void testDoOCR_File_Rectangle() throws Exception {
        ...
        File imageFile = new File(testdata + "eurotext.bmp");
    ...
    public void testDoOCR_List_Rectangle() throws Exception {
        ...
        File imageFile = new File(testdata + "eurotext.pdf");
    ...
    public void testDoOCR_BufferedImage() throws Exception {
        ...
        File imageFile = new File(testdata + "eurotext.gif");
    ...
    public void testDoOCR_SkewedImage() throws Exception {
        ...
        File imageFile = new File(testdata + "eurotext_deskew.png");
        BufferedImage bi = ImageIO.read(imageFile);
